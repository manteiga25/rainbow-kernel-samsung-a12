...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[] = {
	...
	{ 3280, 2464,    0,    0, 3280, 2464,  820,  616,
	    10,    8,  800,  600,    0,    0,  800,  600 }, /*custom1*/
	{ 3280, 2464,    0,    0, 3280, 2464, 3280, 2464,
...
kal_uint16 addr_data_pair_init_skip_otp_sr846d[] = {
	0x004C, 0x0000,
	0x0E16, 0x0100,
	0x5000, 0x120B,
	0x5002, 0x120A,
...
static void sensor_init(void)
{
	...
	pr_info("[%s] skip otp init setting (setfile: v10.4_SEC9), sr846d_is_default_cal: %d", __func__, get_sr846d_is_default_cal());
	ret = sr846d_table_write_cmos_sensor(
		addr_data_pair_init_skip_otp_sr846d,
		sizeof(addr_data_pair_init_skip_otp_sr846d) /
		sizeof(kal_uint16));
	if (ret != 0) {
...
static void custom2_setting(void)
{
	LOG_INF("E\n");
	sr846d_table_write_cmos_sensor(
		addr_data_pair_custom2_3_sr846d,
		sizeof(addr_data_pair_custom2_3_sr846d) /
		sizeof(kal_uint16));
}
...
static void custom4_setting(void)
{
	LOG_INF("E\n");
	sr846d_table_write_cmos_sensor(
		addr_data_pair_custom4_sr846d,
		sizeof(addr_data_pair_custom4_sr846d) /
		sizeof(kal_uint16));
}
...
kal_uint16 otp_readonly_init_sr846d[] = {
	0x004C, 0x0000,
	0x2000, 0x0001,
	0x2002, 0x00FF,
	0x2004, 0x0006,
...
int sr846d_read_otp_cal(unsigned int addr, unsigned char *data, unsigned int size)
{
	...
	pr_info("%s,OTP Read only initial setting\n", __func__);
